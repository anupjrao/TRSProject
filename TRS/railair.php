...
<input id="9" type="checkbox" name="slist[]" value="9" class="seat"/>&nbsp;<input id="10" type="checkbox" name="slist[]" value="10" class="seat"/><br/>
<input id="11" type="checkbox" name="slist[]" value="11" class="seat"/>&nbsp;<input id="12" type="checkbox" name="slist[]" value="12" class="seat"/><br/>
<input id="13" type="checkbox" name="slist[]" value="13" class="seat"/>&nbsp;<input id="14" type="checkbox" name="slist[]" value="14" class="seat"/><br/>
<input id="15" type="checkbox" name="slist[]" value="15" class="seat" />&nbsp;<input id="16" type="checkbox" name="slist[]" value="16" class="seat"/><br/>
<input id="17" type="checkbox" name="slist[]" value="17" class="seat" />&nbsp;<input id="18" type="checkbox" name="slist[]" value="18" class="seat"/><br/>
<input id="19" type="checkbox" name="slist[]" value="19" class="seat" />&nbsp;<input id="20" type="checkbox" name="slist[]" value="20" class="seat"/><br/>
